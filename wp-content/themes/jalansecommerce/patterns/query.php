...
<div class="wp-block-query">
	<!-- wp:post-template -->
		...
		<!-- wp:pattern {"slug":"jalansecommerce/hidden-post-meta"} /-->
	...
	<!-- /wp:post-template -->
	<!-- wp:query-no-results -->
	<!-- wp:paragraph --><p><?php esc_html_e( 'No results found.', 'jalansecommerce'); ?></p><!-- /wp:paragraph -->
	<!-- /wp:query-no-results -->
